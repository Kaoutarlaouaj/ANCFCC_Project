...
// Ensuite, générez le HTML pour les résultats (c'est un exemple simplifié) :
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<div class="col-sm-3"><label style="color:#E3AA01;margin-left: 34px;" >Commune :</label></div>';
        echo '<div class="col-sm-8">';
        echo '<select class="form-control" id="selectCommune" name="commune" required style="margin-left: 58px;">';
