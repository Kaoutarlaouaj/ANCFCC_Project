...
margin-top: -4921px;">Modifier</button>
    ...
    <div class="row justify-content-center">
        <div  class="col-sm-6 cop-ck">
        <br>
            <h2 style="text-align: center; margin-top: 20px;color:#51713F;">Formulaire de distraction</h2>
            <br>
            <fieldset id="groupedLabels">
                <legend style="color:#374D72;">Situation administrative :</legend>
                <br>
...
if ($resultat->num_rows > 0) {
    echo '<div class="row cf-ro">';
    echo '<div class="col-sm-3"><label style="color:#E3AA01;margin-left: 30px;">Province :</label></div>';
    echo '<div class="col-sm-8">';
    echo '<select class="form-control" id="selectList" name="province" required style="margin-left: 30px;">';
...
if ($resultatdpanef->num_rows > 0) {
    echo '<div class="row cf-ro">';
    echo '<div class="col-sm-3"><label style="color:#E3AA01;margin-left: 28px;">Dpanef :</label></div>';
    echo '<div class="col-sm-8">';
    echo '<select class="form-control" id="selectListDpanefF" name="dpanef"  style="margin-left: 30px;">';
...
<!-- Liste déroulante pour les zones -->
<div class="row cf-ro">
    <div class="col-sm-3"><label style="color:#E3AA01;margin-left: -3px;">Zone forestière :</label></div>
    <div class="col-sm-8">
        <select class="form-control" id="selectListZoneZ" name="zone"  style="margin-left: 30px;">
            <!-- Générer les options dynamiquement ici -->
        </select>
    </div>
</div>
...
<div class="row cf-ro">
    <div class="col-sm-3"><label style="color:#E3AA01;margin-left: -11px;">District Forestier :</label></div>
    <div class="col-sm-8">
        <select class="form-control" id="selectListDistrictD" name="district"  style="margin-left: 30px;">
            <!-- Générer les options dynamiquement ici -->
        </select>
    </div>
</div>
...
<script>
    ...
    function loadZones(selectedDPANEF) {
        // Effectuez une requête AJAX pour obtenir les zones en fonction de DPANEF
        fetch('get_zones2.php?dpanef=' + selectedDPANEF)
            .then(response => response.text())
            .then(data => {
                // Mettez à jour les options de la liste déroulante des zones
                document.getElementById("selectListZoneZ").innerHTML = data;
            });
    }
    ...
    function loadDistricts(selectedDPANEF, selectedZone) {
        // Effectuez une requête AJAX pour obtenir les districts forestiers en fonction de DPANEF et de la zone
        fetch('get_districts3.php?dpanef=' + selectedDPANEF + '&zone=' + selectedZone)
            .then(response => response.text())
            .then(data => {
                // Mettez à jour les options de la liste déroulante des districts forestiers
                document.getElementById("selectListDistrictD").innerHTML = data;
            });
    }
       // Fonction pour charger les districts forestiers en fonction de DPANEF et de la zone sélectionnée
       function loadDistricts2(selectedDPANEF) {
        // Effectuez une requête AJAX pour obtenir les districts forestiers en fonction de DPANEF et de la zone
        fetch('get_districts4.php?dpanef=' + selectedDPANEF)
            .then(response => response.text())
            .then(data => {
                // Mettez à jour les options de la liste déroulante des districts forestiers
                document.getElementById("selectListDistrictD").innerHTML = data;
    ...
    var selectedDPANEF = document.getElementById("selectListDpanefF").value;
        loadZones(selectedDPANEF);
    // Ajoutez un événement de changement à la liste déroulante DPANEF
    document.getElementById("selectListDpanefF").addEventListener("change", function() {
        var selectedDPANEF = this.value;
        loadZones(selectedDPANEF);
    });
    var selectedDPANEF =document.getElementById("selectListDpanefF").value;
...
//var selectedDPANEF = document.getElementById("selectListDpanef").value;
   ...
   // loadDistricts(selectedDPANEF, selectedZone);
// Ajoutez un événement de changement à la liste déroulante des zones
document.getElementById("selectListZoneZ").addEventListener("change", function() {
    var selectedDPANEF = document.getElementById("selectListDpanefF").value;
    var selectedZone = document.getElementById("selectListZoneZ").value;
    loadDistricts(selectedDPANEF, selectedZone);
});
            ...
            <fieldset id="groupedLabels">
                ...
                <br>
                <div class="row cf-ro"> 
                        <label style="color:#E3AA01;margin-left: 20px;">Forêt/Canton/Ilôt :</label>
                        <div class="col-sm-8"><input type="text" name="name" class="form-control input-sm" style="margin-left: 23px;" required></div>
                </div>
                <br>
                <div class="row cf-ro"> 
                    <label style="color:#E3AA01;margin-left: 36px;">Stade Fonciére :</label>
                    <div class="col-sm-8"><input type="text" name="stade" class="form-control input-sm" style="margin-left: 23px;" required></div>
                </div>
                <br>
                <div class="row cf-ro"> 
                    <label style="color:#E3AA01;margin-left: 71px;">Réferénce :</label>
                    <div class="col-sm-8"><input type="text" name="ref" class="form-control input-sm" style="margin-left: 24px;" required></div>
                </div>
                <br>
                <div class="row cf-ro"> 
                    <div  class="col-sm-3"><label style="color:#E3AA01;margin-left: 35px;">Superficie de la parcelle en m2 :</label></div>
                    <div class="col-sm-8"><input type="number" name="sup" min="0"  step="1" required style="margin-left: 38px;"></div>
                </div>
            </fieldset>
                <br>
                <div  class="row cf-ro">
                    <div  class="col-sm-3"><label style="color:#E3AA01;margin-left: 28px;">Bénéficiare :</label></div>
                    <div class="col-sm-8"><input type="text" name="benef" class="form-control input-sm" required style="margin-left: 39px;"></div>
                </div>
                <br>
                 <div  class="row cf-ro">
                    <div  class="col-sm-3"><label style="color:#E3AA01;margin-left: 18px;">Projet réalisé:</label></div>
                    <div class="col-sm-8"><input type="text" name="projet" class="form-control input-sm" required style="margin-left: 39px;"></div>
                </div>
                <br>
                <fieldset id="groupedLabels">
                    <legend style="color:#374D72;">Chronologie:</legend>
                    <br>
                    <div class="row cf-ro"> 
                            <label style="color:#E3AA01;margin-left: 27px;">Date de Demande :</label>
                            <div class="col-sm-8"><input type="date" name="Date" required style="margin-left: 18px;"></div>
                    </div>
                    <br>
                            <div class="row cf-ro"> 
                             <label style="color:#E3AA01;margin-left: 40px;">Date Provinciale :</label>
                             <div class="col-sm-8"><div class="col-sm-8"><input type="date" name="prov" required style="margin-left: 8px;"></div></div>
                            </div>
                        <br>
                            <div class="row cf-ro"> 
                                <label style="color:#E3AA01;margin-left: 47px;">Date Régionale :</label>
                                <div class="col-sm-8"><div class="col-sm-8"><input type="date" name="reg" style="margin-left: 8px;" ></div></div>
                            </div>
                            <br>
                            <div class="row cf-ro"> 
                                <label style="color:#E3AA01;margin-left: 26px;">Accord de principe :</label>
                                <div class="col-sm-8"><div class="col-sm-8"><input type="date" name="Acc" style="margin-left: 8px;" required></div></div>
                            </div>
                            <br>
                            <div class="row cf-ro"> 
                                <label style="margin-left:-79px; color:#E3AA01;margin-left: -37px;">Commission Amninistrative :</label>
                                <div class="col-sm-8"><div class="col-sm-8"><input type="date" name="Comm" required style="margin-left: 10px;"></div></div>
                            </div>
                            <br>
                            <div class="row cf-ro"> 
                                <label style="color:#E3AA01;margin-left: 1px;">Commission Expertise :</label>
                                <div class="col-sm-8"><div class="col-sm-8"><input type="date" name="Exp" required style="margin-left: 10px;"></div></div>
                            </div>
                            <br>
                            <div class="row cf-ro"> 
                                <label style="color:#E3AA01;margin-left: 53px;">Envoi du dossier :</label>
                ...
                <fieldset id="groupedLabels">
                    ...
                    <br>
                    <div class="row cf-ro"> 
                            <label style="color:#E3AA01;margin-left: 103px;">Prix en Ha :</label>
                            <div class="col-sm-8"><input type="number" name="prix" min="0"  step="1" required></div>
                    </div>
                    <br>
                            <div class="row cf-ro"> 
                             <label style="color:#E3AA01;margin-left: 80px;">Montant total :</label>
                             <div class="col-sm-8"><input type="number" name="montant" min="0"  step="1" required></div>
                            </div>
                </fieldset>
                <br>
                <div  class="row cf-ro">
                    <label style="color:#E3AA01;margin-left: 58px;">Référence Décrit :</label>
                    <div class="col-sm-8"><input type="text" name="refD" class="form-control input-sm"></div>
                </div>
                <br>
                <div  class="row cf-ro">
                    <label style="color:#E3AA01;margin-left: 7px;">Référence PV de remise :</label>
                    <div class="col-sm-8"><input type="text" name="refP" class="form-control input-sm"></div>
                </div>
                <br>
                <label for="kmzFile">Sélectionnez un fichier KMZ :</label>
...
<br>
  ...
  margin-top: 30px;color:#E3AA01;">Observation :</label>
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="obsr"></textarea>

                    </div>
                    <br>
                    <div class="col-sm-8">
                         <button type="submit" class="btn btn-success btn-sm" name="submit_button">Envoyer</button>
                         <button type="reset" name="deleteForm" id="deleteForm" class='btn btn-sm btn-danger' style="margin-left: -107px;
margin-top: -4855px;">Supprimer</button>
<button name="UpdateForm" class='btn btn-sm btn-warning' style="margin-left: 33px;
margin-top: -4855px;" onclick="modifierFormulaire()" id="UpdateForm">Modifier</button>
<script>
    // ... (Code JavaScript existant pour créer les champs X et Y)
    document.addEventListener('DOMContentLoaded', function () {
    // Fonction pour créer un champ de coordonnées X et Y
// Fonction pour créer un champ de coordonnées X et Y
function creerChampCoordonnees() {
    const container = document.getElementById('coordonnees-container');
    const S = document.getElementById('deleteForm');
    const U = document.getElementById('UpdateForm');
    const divRowX = document.createElement('div');
    divRowX.className = 'row cf-ro';
    S.style.marginLeft = "-107px";
    S.style.marginTop = "-4876px"; 
    U.style.marginLeft = "33px";
    U.style.marginTop = "-4876px"; 
    const labelX = document.createElement('label');
    labelX.textContent = 'X :';
    labelX.style ='color:#E3AA01;';
    const divColX = document.createElement('div');
    divColX.className = 'col-sm-8';

    const inputX = document.createElement('input');
    inputX.type = 'text';
    inputX.name = 'x[]'; // Utilisez un nom de champ en tableau
    inputX.required = true;

    divColX.appendChild(inputX);
    divRowX.appendChild(labelX);
    divRowX.appendChild(divColX);

    const divRowY = document.createElement('div');
    divRowY.className = 'row cf-ro';

    const labelY = document.createElement('label');
    labelY.textContent = 'Y :';
    labelY.style ='color:#E3AA01;';
    const divColY = document.createElement('div');
    divColY.className = 'col-sm-8';

    const inputY = document.createElement('input');
    inputY.type = 'text';
    inputY.name = 'y[]'; // Utilisez un nom de champ en tableau
    inputY.required = true;

    divColY.appendChild(inputY);
    divRowY.appendChild(labelY);
    divRowY.appendChild(divColY);

    container.appendChild(divRowX);
    container.appendChild(divRowY);
}

// ... (Code JavaScript existant pour la gestion des événements)
    
    // Gérer le clic sur le bouton "Ajouter une paire de coordonnées"
    const boutonAjouterCoordonnees = document.getElementById('ajouter-coordonnees');
    boutonAjouterCoordonnees.addEventListener('click', creerChampCoordonnees);
});
</script>
...
if (isset($_POST["submit_button"])) {
   ...
   include('../connexion.php');
        ...
        // Récupérer les coordonnées depuis le formulaire
...
// Préparer la requête d'insertion en incluant les chaînes JSON
    ...
    VALUES ('$province', '$commune', '$dpanef', '$zone_forestiere', '$district_forestier', '$foret_canton_ilot', '$stade_fonciere', '$reference', '$superficie_parcelle_m2', '$beneficiaire', '$projet_realise', '$date_demande', '$date_provinciale', '$date_regionale', '$date_accord_principe', '$date_commission_administrative', '$date_commission_expertise', '$date_envoi_dossier', '$prix_en_ha', '$montant_total', '$reference_decrit', '$reference_pv_remise', '$observation')";
        ...
        if ($conn->query($sql) === TRUE) {
            //$adresseGPS = str_replace(" ","+",$nom_commune);
               ...
               $query = "SELECT d.id
               FROM distraction AS d
               WHERE d.Province = ? OR d.Commune = ? OR d.DPANEF = ? OR d.Zone_forestiere = ? OR d.District_forestier = ? OR d.Foret_canton_ilot LIKE ? OR d.Stade_fonciere LIKE ? OR d.Reference LIKE ? OR d.Superficie_parcelle_m2 = ? OR d.Beneficiaire LIKE ? OR d.Projet_realise LIKE ? OR d.Prix_en_Ha = ? OR d.Montant_total = ? OR d.Reference_decrit LIKE ? OR d.Reference_PV_remise LIKE ? ";
     
    // $likeR = '%' . $R . '%';
     
     $stmt = $conn->prepare($query);
     $stmt->bind_param("ssssssssissiiss",$province,$commune,$dpanef,$zone_forestiere,$district_forestier,$foret_canton_ilot,$stade_fonciere,$reference,$superficie_parcelle_m2,$beneficiaire,$projet_realise,$prix_en_ha,$montant_total,$reference_decrit,$reference_pv_remise);
     $stmt->execute();
     $result = $stmt->get_result();
     ...
     if ($result->num_rows > 0) {
         ...
         while ($rowT = $result->fetch_assoc()) {
            ...
            if (isset($_FILES["files"])) {
                ...
                for ($i = 0; $i < $totalFichiers; $i++) {
                    ...
                    if (move_uploaded_file($cheminTemporaire, $cheminDestination)) {
                        ...
                        $sqlInsert = "INSERT INTO fichiers_importes (nom_fichier, chemin_fichier,id_distraction) VALUES ('$nomFichier', '$cheminDestination','$id')";
           ...
           $query = "INSERT INTO table_kmz (nom_fichier, kmz_content ,id_distraction) VALUES (?, ?,?)";
           $stmt = $conn->prepare($query);
...
<br>
  ...
  <br>
                ...
                <h1 class="h3 mb-0 text-gray-800" style="margin-left: 245px;">Acquisition</h1>
                <div class="container mt-5">
    <div class="row">
      <div class="col">
      <form method="post">
  ...
  height: 0px;">
        ...
        <!--
        <a href="ajouter_formulaire.php?myid=">Supprimer</a>
