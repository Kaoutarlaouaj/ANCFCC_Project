...
<br>
                ...
                <h1 class="h3 mb-0 text-gray-800" style="margin-left:244px;">Distraction</h1>
...
margin-top: -4921px;">Modifier</button>
    ...
    ouiRadioButton.addEventListener("click", function () {
        if (ouiRadioButton.checked) {
            ...
            deleteButton.style.marginTop = "-5640px"; 
            updateButton.style.marginLeft = "28px";
            updateButton.style.marginTop = "-5640px"; 
        } 
    });
    nonRadioButton.addEventListener("click", function () {
        if (nonRadioButton.checked) {
...
if ($resultat->num_rows > 0) {
    ...
    echo '<div class="col-sm-8">';
    echo '<select class="form-control" id="selectList"style="margin-left: 57px;"  name="province" required>';
...
if ($resultatdpanef->num_rows > 0) {
    ...
    echo '<div class="col-sm-8">';
    echo '<select class="form-control" id="selectListDpanef" style="margin-left: 58px;" name="dpanef" required>';
...
<div class="row cf-ro">
    <div class="col-sm-3"><label style="color:#E3AA01;">Zone forestière :</label></div>
    <div class="col-sm-8">
        <select class="form-control" id="selectListZone" style="margin-left: 61px;" name="zone" required>
            <!-- Générer les options dynamiquement ici -->
        </select>
    </div>
</div>
...
<div class="row cf-ro">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="selectListDistrict" style="margin-left: 63px;" name="district" required>
            <!-- Générer les options dynamiquement ici -->
        </select>
    </div>
</div>
