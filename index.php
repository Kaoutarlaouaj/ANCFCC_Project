...
<head>
    ...
    <link href="Ajouter/css/sb-admin-2.min.css" rel="stylesheet">
...
echo '<img class="img-profile rounded-circle" src="Ajouter/img/undraw_profile.svg">';
echo '</a>';
...
?>
    ...
    <script src="Ajouter/vendor/jquery/jquery.min.js"></script>
    <script src="Ajouter/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="Ajouter/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="Ajouter/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="Ajouter/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="Ajouter/js/demo/chart-area-demo.js"></script>
    <script src="Ajouter/js/demo/chart-pie-demo.js"></script>
